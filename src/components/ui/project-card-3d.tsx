    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden rounded-xl">
          <Card className="w-full h-full flex flex-col overflow-hidden glassmorphic glassmorphic-dark">
            {project.imageUrl && (
            ...
            <CardHeader className={cn("flex-grow", project.imageUrl ? "pt-4" : "")}>
            ...
            <CardFooter className="pt-0">
                <Button variant="link" className="text-sm p-0 h-auto text-accent">
        ...
        <div className="absolute inset-0 rotate-y-180 backface-hidden rounded-xl">
          <Card className="w-full h-full flex flex-col p-6 glassmorphic glassmorphic-dark">
            <CardTitle className="font-headline text-xl text-primary mb-2">{project.title}</CardTitle>
            <CardContent className="flex-grow space-y-3 overflow-y-auto scrollbar-thin scrollbar-thumb-muted-foreground/50 scrollbar-track-transparent pr-2">
              <p className="text-sm text-foreground">{project.longDescription || project.description}</p>
